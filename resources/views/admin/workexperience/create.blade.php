                ...
                <div class="col-md-10">
                    <div class="card">
                        <form action="{{route('experience.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <h4 class="card-title">Create Work Experience</h4>
                                <div class="form-group row">
                                    <label for="employer_name" class="col-sm-2 text-right control-label col-form-label">Employer Name</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="employer_name" class="form-control" id="employer_name" placeholder="Enter a employer name">
                                    </div>
                                    <label for="location" class="col-sm-2 text-right control-label col-form-label">Job Location</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="location" class="form-control" id="location" placeholder="Enter a job location">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="job_desc" class="form-control" id="job_desc" placeholder="Enter job description" >
                                    </div>
                                </div>
                            </div>

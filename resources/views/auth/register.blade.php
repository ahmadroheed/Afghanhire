...
<head>
    ...
    <title>Afghanhire Admin Panel</title>
    <!-- Custom CSS -->
                    ...
                    <div class="row p-b-30">
                        <div class="col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="username" class="form-control form-control-lg{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="Enter username" aria-label="Username" aria-describedby="basic-addon1" required="">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" name="confirmed" class="form-control form-control-lg{{ $errors->has('confirmed') ? ' is-invalid' : '' }}" placeholder="confirm password" aria-label="confirm password" aria-describedby="basic-addon1" required="">
                    ...
                    <div class="row border-top border-secondary">
                        <div class="col-12">
                            <div class="form-group">
                                <div class="p-t-20">
                                    <a href="{{route('login')}}">
                                        <button class="btn btn-info" type="button"><i class="fa fa-user m-r-5"></i> Already Register</button>
                                    </a>
                                    <button class="btn btn-success float-right" type="submit"><i class="fa fa-plus m-r-5"></i>Register</button>
                                </div>
                            </div>
                        </div>
                    </div>
